...
export const Sidebar = () => (
  <aside className="hidden w-64 shrink-0 border-r border-zinc-800 bg-zinc-950 px-4 py-6 md:block">
    <div className="px-3 pb-8">
      <p className="text-xs font-semibold uppercase tracking-wider text-zinc-500">TicketAI</p>
      <h1 className="mt-1 text-xl font-semibold text-white">Support Ops</h1>
    </div>
